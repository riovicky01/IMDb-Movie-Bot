...
async def next_page(bot, query):
    ...
    btn.insert(0,
            [
                InlineKeyboardButton("⭕️ Movie", url="https://t.me/BlackTicketdis"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/BlackTicketdis'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/BlackTicketdis')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/blackfilmdis')
            ]
            ]
        ...
        buttons = [
            [
                InlineKeyboardButton('⭕️ Support', url='https://t.me/blackfilmdis'),
                InlineKeyboardButton('Channel ⭕️', url='https://t.me/BlackTicketdis')
            ],
            [
                InlineKeyboardButton('🎬 Series & Movie Club 🎬', url=f'https://t.me/BlackTicketdis')
            ]
            ]
        await query.answer()
        await client.send_cached_media(
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Movie Club ⭕️', url='https://t.me/BlackTicketdis')
            ],[
...
async def auto_filter(client, msg, spoll=False):
    ...
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Movie", url="https://t.me/BlackTicketdis"),
        InlineKeyboardButton("Series ⭕️", url="https://t.me/BlackTicketdis")
    ])https://t.me/imdhttps://t.me/imdbprobots/4bprobots/4
    btn.insert(0, [
        InlineKeyboardButton("⭕️ Join Our Channel ⭕️",url="https://t.me/BlackTicketdis")
    ])
